...
namespace Hackathon.DAL.Migrations
{
    ...
    [Migration("20230225084606_Events_Add_Rules")]
    partial class Events_Add_Rules
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hackathon.Entities.Event.EventEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Hackathon.Entities.Event.EventStageEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Hackathon.Entities.EventLogEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EventsTeams", b =>
                {
                    b.HasOne("Hackathon.Entities.Event.EventEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hackathon.Entities.Event.EventStageEntity", b =>
                {
                    b.HasOne("Hackathon.Entities.Event.EventEntity", "Event")
                        .WithMany("Stages")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
