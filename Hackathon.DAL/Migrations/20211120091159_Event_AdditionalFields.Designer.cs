...
namespace Hackathon.DAL.Migrations
{
    ...
    [Migration("20211120091159_Event_AdditionalFields")]
    partial class Event_AdditionalFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hackathon.Common.Entities.EventEntity", b =>
                {
                    ...
                    b.Property<DateTime>("StartMemberRegistration")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Hackathon.Common.Entities.ProjectEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Hackathon.Common.Entities.ProjectEntity", b =>
                {
                    b.HasOne("Hackathon.Common.Entities.TeamEntity", "Team")
                        .WithOne("Project")
                        .HasForeignKey("Hackathon.Common.Entities.ProjectEntity", "TeamId")
