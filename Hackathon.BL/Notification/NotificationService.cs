...
public class NotificationService: INotificationService
{
    ...
    private readonly IIntegrationEventsHub<NotificationChangedIntegrationEvent> _notificationsHub;

    public NotificationService(
        INotificationRepository notificationRepository,
        IIntegrationEventsHub<NotificationChangedIntegrationEvent> notificationsHub)
    {
    ...
    public async Task DeleteAsync(long userId, Guid[] notificationIds = null)
    {
        ...
        await _notificationsHub.PublishAll(TopicNames.NotificationChanged,
